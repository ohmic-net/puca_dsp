// ESP32 internet radio example for PÚCA DSP development board Original Edition with 4MB Flash & PSRAM Enabled
...
String ssid =     "XXXXXXXXXX";   // Enter WiFi Network settings here
...
void change_station (void) {     // add new stations or change stations here
