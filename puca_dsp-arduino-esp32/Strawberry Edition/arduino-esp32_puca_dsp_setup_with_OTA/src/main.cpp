...
// for PUCA_DSP development board Strawberry Edition (16MB Flash, PSRAM disabled)
...
//   printf("Register Value = %d \n", regval); // check and print register value for register 7 
//   vTaskDelay(10000/portTICK_RATE_MS);   
//   wm8978.sleep(1); // after 10 seconds, set the audio codec to standby mode 
//   vTaskDelay(5000/portTICK_RATE_MS); 
//   esp_deep_sleep_start();  // after another 5 seconds, enter ESP32 deep sleep 
