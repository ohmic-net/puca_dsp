...
/* ------------------------------------------------------------
name: "picodsp_mics_endfire_array"
...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("filename", "picodsp_mics_endfire_array.dsp");
		...
		m->declare("name", "picodsp_mics_endfire_array");
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("picodsp_mics_endfire_array");
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
			...
			output0[i0] = FAUSTFLOAT((fRec0[6] - fRec1[0]));
			fVec0[1] = fVec0[0];
...
picodsp_mics_endfire_array::picodsp_mics_endfire_array(int sample_rate, int buffer_size)
{
    fUI = new MapUI();
...
picodsp_mics_endfire_array::~picodsp_mics_endfire_array()
{
    delete fDSP;
    delete fUI;
    delete fAudio;
...
bool picodsp_mics_endfire_array::start()
{
#ifdef MIDICTRL
...
void picodsp_mics_endfire_array::stop()
{
#ifdef MIDICTRL
    fMIDIInterface->stop();
#endif
...
void picodsp_mics_endfire_array::setParamValue(const std::string& path, float value)
{
    fUI->setParamValue(path, value);
}

float picodsp_mics_endfire_array::getParamValue(const std::string& path)
{
...
extern "C" void app_main()
{
    ...
    picodsp_mics_endfire_array* DSP = new picodsp_mics_endfire_array(48000, 32);
    DSP->start();
