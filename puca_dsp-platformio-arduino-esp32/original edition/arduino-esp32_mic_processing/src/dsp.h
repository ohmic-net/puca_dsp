...
private:
    ...
    int32_t dspBuffer[DSP_BLOCK_SIZE * 2]{};

    // Input microphone buffer (2 mics, 2 channels interleaved)
    int32_t micBuffer[DSP_BLOCK_SIZE * 2]{};
    ...
    int32_t delayLine[END_FIRE_DELAY_SAMPLES]{};
    size_t delayIndex = 0;
