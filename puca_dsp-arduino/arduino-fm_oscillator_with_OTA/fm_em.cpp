  ...
  public:
	...
	void fillmydspSIG0(int count, float* table) {
		for (int i = 0; (i < count); i = (i + 1)) {
			iRec0[0] = (iRec0[1] + 1);
			table[i] = std::sin((0.00613592332f * float((iRec0[0] + -1))));
			iRec0[1] = iRec0[0];
		}
	}
...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("freq", &fHslider0, 330.0f, 50.0f, 2000.0f, 0.100000001f);
		ui_interface->addHorizontalSlider("harmonicity Ratio", &fHslider1, 2.0f, 0.0f, 10.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("index", &fHslider2, 375.0f, 0.0f, 1000.0f, 0.00999999978f);
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			float fTemp0 = (fRec5[1] + (fConst0 * (fRec2[0] * fRec3[0])));
			fRec5[0] = (fTemp0 - std::floor(fTemp0));
			float fTemp1 = (fRec1[1] + (fConst0 * (fRec2[0] + ((fRec3[0] * fRec4[0]) * ftbl0mydspSIG0[int((1024.0f * fRec5[0]))]))));
			fRec1[0] = (fTemp1 - std::floor(fTemp1));
			output0[i] = FAUSTFLOAT(ftbl0mydspSIG0[int((1024.0f * fRec1[0]))]);
			fRec2[1] = fRec2[0];
			fRec3[1] = fRec3[0];
			fRec4[1] = fRec4[0];
			fRec5[1] = fRec5[0];
	...
	FAUST_ADDHORIZONTALSLIDER("[0]FM/freq", fHslider0, 330.0f, 50.0f, 2000.0f, 0.10000000000000001f);
	FAUST_ADDHORIZONTALSLIDER("[0]FM/harmonicity Ratio", fHslider1, 2.0f, 0.0f, 10.0f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("[0]FM/index", fHslider2, 375.0f, 0.0f, 1000.0f, 0.01f);
#endif
...
fm_em::fm_em(int sample_rate, int buffer_size)
{
    fUI = new MapUI();
...
void fm_em::setParamValue(const std::string& path, float value)
{
    fUI->setParamValue(path, value);
}

float fm_em::getParamValue(const std::string& path)
{
