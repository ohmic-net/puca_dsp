...
void network::mdnsInit(void)
{
    ...
    //set hostname
    mdns_hostname_set("pico_dsp");
    //set default instance
    mdns_instance_name_set("pico_dsp");
	...
	ESP_ERROR_CHECK(mdns_service_add("pico_dsp", "_http", "_tcp", 80, serviceTxtData,
                                     sizeof(serviceTxtData) / sizeof(serviceTxtData[0])));

	mdns_service_instance_name_set("_http", "_tcp", "pico_dsp");
    return;
}
