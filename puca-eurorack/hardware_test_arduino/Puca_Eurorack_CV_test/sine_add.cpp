...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("sine_add");
		ui_interface->addHorizontalSlider("freq", &fHslider0, 220.0f, 20.0f, 16744.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("gain1", &fHslider1, 0.300000012f, 0.0f, 1.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("gain2", &fHslider2, 0.200000003f, 0.0f, 1.0f, 0.00999999978f);
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			float fTemp1 = (fRec3[1] + (fConst2 * (fRec2[0] * fRec4[0])));
			fRec3[0] = (fTemp1 - std::floor(fTemp1));
			fRec6[0] = (fSlow2 + (0.999000013f * fRec6[1]));
			float fTemp2 = (fRec5[1] + (fConst3 * (fRec2[0] * fRec6[0])));
			fRec5[0] = (fTemp2 - std::floor(fTemp2));
			output0[i] = FAUSTFLOAT((0.300000012f * ((0.300000012f * (ftbl0mydspSIG0[int((1024.0f * fRec1[0]))] + ftbl0mydspSIG0[int((1024.0f * fRec3[0]))])) + ftbl0mydspSIG0[int((1024.0f * fRec5[0]))])));
			fRec2[1] = fRec2[0];
			fRec1[1] = fRec1[0];
			fRec4[1] = fRec4[0];
			fRec3[1] = fRec3[0];
...
sine_add::sine_add(int sample_rate, int buffer_size)
{
    fUI = new MapUI();
...
void sine_add::setParamValue(const std::string& path, float value)
{
    fUI->setParamValue(path, value);
}

float sine_add::getParamValue(const std::string& path)
{
