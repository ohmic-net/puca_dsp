...
/* ------------------------------------------------------------
name: "picodsp_mics_omnidirectional"
...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		m->declare("filename", "picodsp_mics_omnidirectional.dsp");
		...
		m->declare("name", "picodsp_mics_omnidirectional");
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("picodsp_mics_omnidirectional");
...
picodsp_mics_omnidirectional::picodsp_mics_omnidirectional(int sample_rate, int buffer_size)
{
    fUI = new MapUI();
...
picodsp_mics_omnidirectional::~picodsp_mics_omnidirectional()
{
    delete fDSP;
    delete fUI;
    delete fAudio;
...
bool picodsp_mics_omnidirectional::start()
{
#ifdef MIDICTRL
...
void picodsp_mics_omnidirectional::stop()
{
#ifdef MIDICTRL
    fMIDIInterface->stop();
#endif
...
void picodsp_mics_omnidirectional::setParamValue(const std::string& path, float value)
{
    fUI->setParamValue(path, value);
}

float picodsp_mics_omnidirectional::getParamValue(const std::string& path)
{
...
extern "C" void app_main()
{
    ...
    picodsp_mics_omnidirectional* DSP = new picodsp_mics_omnidirectional(48000, 32);
    DSP->start();
